...
const EduHubLegal = (function() {
    ...
    const DICTIONARY = {
        en: {
            ...
            modal_b1: "<strong>14-Day 100% Guarantee:</strong> Full refund if requested within 14 days via 1-click AI portal at /support or support@eduhub.ai.",
        ...
        ru: {
            ...
            modal_b1: "<strong>14-дневная 100% гарантия возврата:</strong> Полный возврат при обращении в течение 14 дней в 1 клик на /support или через support@eduhub.ai.",
        ...
        es: {
            ...
            modal_b1: "<strong>Garantía de 14 Días 100%:</strong> Reembolso íntegro solicitándolo en los primeros 14 días mediante el portal /support o en support@eduhub.ai.",
