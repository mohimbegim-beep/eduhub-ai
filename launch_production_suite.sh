        ...
        },
        {
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "EduHub AI offers an unconditional 14-day 100% money-back guarantee on all subscription plans and sprint passes. Simply contact mahallamade.uz@gmail.com for an immediate, hassle-free refund."
              }
            },
            {
              "@type": "Question",
            ...
            <div class="space-y-4">
                ...
                <details class="group bg-slate-900/70 border border-slate-800/80 rounded-xl p-5 [&_summary::-webkit-details-marker]:hidden cursor-pointer">
                    ...
                    <p class="text-xs text-slate-400 mt-3 leading-relaxed" data-i18n="faq_a2">
                        We offer a no-questions-asked 100% refund within 14 days of any purchase or renewal. To initiate a refund, simply send an email to mahallamade.uz@gmail.com, and our team will issue the credit back to your card within 24 hours.
                    </p>
                </details>
                ...
                <details class="group bg-slate-900/70 border border-slate-800/80 rounded-xl p-5 [&_summary::-webkit-details-marker]:hidden cursor-pointer">
                    ...
                    <p class="text-xs text-slate-400 mt-3 leading-relaxed" data-i18n="faq_a5">
                        Yes. You can cancel recurring subscriptions anytime directly from your customer portal link or by emailing mahallamade.uz@gmail.com. You will retain full access until the end of your prepaid period with no cancellation fees.
                    </p>
                </details>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div class="flex flex-wrap justify-center gap-6">
                    ...
                    <a href="mailto:mahallamade.uz@gmail.com" class="text-slate-400 hover:text-white transition underline">Contact: mahallamade.uz@gmail.com</a>
                </div>
            </div>
    ...
    <div id="privacy-modal" class="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full max-h-[80vh] flex flex-col shadow-2xl">
            ...
            <div class="p-6 overflow-y-auto space-y-4 text-xs text-slate-300 leading-relaxed">
                ...
                <p><strong>4. GDPR &amp; Data Subject Rights:</strong> You have the right to request access to, correction of, or permanent deletion of your account and data at any time by contacting mahallamade.uz@gmail.com.</p>
            </div>
            <div class="p-4 border-t border-slate-800 flex justify-end">
    ...
    <div id="refund-modal" class="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full max-h-[80vh] flex flex-col shadow-2xl">
            ...
            <div class="p-6 overflow-y-auto space-y-4 text-xs text-slate-300 leading-relaxed">
                ...
                <p><strong>2. How to Request:</strong> Simply send an email to <a href="mailto:mahallamade.uz@gmail.com" class="text-blue-400 underline">mahallamade.uz@gmail.com</a> with your order number or account email. Our support team will process your refund within 24 business hours.</p>
...
const I18N_DICTIONARY = {
  ...
  en: {
    ...
    faq_a2: "We offer a no-questions-asked 100% refund within 14 days of any purchase or renewal. To initiate a refund, simply send an email to mahallamade.uz@gmail.com, and our team will issue the credit back to your card within 24 hours.",
    ...
    faq_a5: "Yes. You can cancel recurring subscriptions anytime directly from your customer portal link or by emailing mahallamade.uz@gmail.com. You will retain full access until the end of your prepaid period with no cancellation fees.",
  ...
  ru: {
    ...
    faq_a2: "Мы предоставляем 100% возврат средств без лишних вопросов в течение 14 дней с момента оплаты или продления. Напишите на mahallamade.uz@gmail.com, и средства вернутся на карту в течение 24 часов.",
    ...
    faq_a5: "Да. Вы можете отменить подписку в любой момент в личном кабинете или написав на mahallamade.uz@gmail.com. Доступ сохранится до конца оплаченного периода без каких-либо комиссий.",
  ...
  uz: {
    ...
    faq_a2: "Xarid yoki obuna uzaytirilgan kundan boshlab 14 kun ichida 100% to'lovni qaytarib beramiz. Buning uchun mahallamade.uz@gmail.com pochtasiga yozish kifoya, mablag' 24 soat ichida kartangizga qaytariladi.",
    ...
    faq_a5: "Ha. Obunani istalgan vaqtda shaxsiy kabinetingizdan yoki mahallamade.uz@gmail.com manziliga yozib bekor qilishingiz mumkin. To'langan muddat oxirigacha barcha imkoniyatlar saqlanib qoladi.",
  ...
  es: {
    ...
    faq_a2: "Ofrecemos un reembolso del 100% sin preguntas durante los primeros 14 días de cualquier compra. Escribe a mahallamade.uz@gmail.com y devolveremos el importe a tu tarjeta en 24 horas.",
